...
const mockPlaceData: IPlace = {
  id: 1,
  name: '',
  address: '2-chōme-1-6 Togoshi, Shinagawa City, Tokyo 142-0041, Japan',
  placeType: 'onsen',
  location: {
    latitude: 35.614771999999995,
    longitude: 139.718603
  },
  metadata: {
    createdAt: new Date(),
    updatedAt: new Date()
