    ...
    <div class="flex flex-col w-full">
        ...
        <section class="p-3 flex flex-row justify-between">
            <!-- Section listing places you visited and experiences contributed -->
             <VisitedPlaces 
                class="p-3"
                :placesVisitedByTourists="mockPlacesVisitedByUser"
            />
        </section>
        <section class="justify-items-center p-3">
            <!-- Section for buttons-->
            <button class="border border-velvet text-xl rounded  p-3 m-3 hover:bg-velvet hover:text-frostWhite">Search</button>
